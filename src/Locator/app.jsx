    ...
    return(
        <div className="locator">
            ...
            <div className="locatorBody">
                <a href="https://www.google.com/maps/search/hospitals" target="_blank" className="locatorBodyTop1">
                ...
                <a href = "https://www.google.com/maps/search/lgbt+stores" target="_blank" className="locatorBodyTop2">
                ...
                <a href = "https://www.google.com/maps/search/lgbt+restaurants" target="_blank" className="locatorBodyBottom1">
                ...
                <a variant="text" href = "https://www.google.com/maps/search/lgbt+cafes" target="_blank" className="locatorBodyBottom2">
